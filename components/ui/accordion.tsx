// CUSTOMIZED — do not re-run `npx @react-native-reusables/cli add accordion`
// on this file, it will overwrite this change: the default Lucide
// `ChevronDown` trigger icon was swapped for the app's own `ExpandIcon`
// (components/Icons.tsx), so lucide-react-native could be dropped as a
// dependency (see components/ui/index-item.tsx). ExpandIcon already points
// down at rest — the existing 0deg/180deg rotate animation below reproduces
// the up-facing "collapse" look without needing a second icon asset.
        ...
        <AccordionPrimitive.Trigger {...props} asChild>
          <Trigger
            ...
            <Animated.View
              ...
              <ExpandIcon size={16} color={isDark ? Colors.brand100 : Colors.ink200} />
            </Animated.View>
          </Trigger>
